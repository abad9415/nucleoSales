...
$Total=0;
    ...
    $stmt = $bdd->prepare("SELECT prospecto.nombre, monto,vendedor.nombreusuario
                            FROM etapadeventa
                            ...
                            and MONTH(fechadeetapa)=? and YEAR(fechadeetapa) =? order by vendedor.nombreusuario");

     $stmt ->execute(array($Nmes,$anio)); 
