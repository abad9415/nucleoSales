...
(function(f) {
  ...
  q(B.prototype, {
    ...
    getSVG: function(a) {
      ...
      g = d.exporting.sourceWidth || d.chart.width || /px$/.test(g) && parseInt(g, 10) || 3300;
      h = d.exporting.sourceHeight || d.chart.height || /px$/.test(h) && parseInt(h, 10) || 2550;
      q(d.chart, {
        animation: !1,
        renderTo: c,
        forExport: !0,
