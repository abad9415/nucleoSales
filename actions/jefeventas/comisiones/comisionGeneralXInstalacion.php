...
if($totalComisiones == 0){
  $actionComisionSQL = 'agregarComisionAtodosVendedoresXInstalacion';
}else{
  $actionComisionSQL = 'agregarComisionAtodosVendedoresUpdateXInstalacion';
}
 ...
 echo "La comision ahora sera de " . $_POST['comisionGeneral'] . "% Por Instalación";
?>